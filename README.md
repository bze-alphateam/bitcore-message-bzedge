...
bitcore-message-bzedge adds support for verifying and signing BZEdge messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-bzedge
```

```sh
bower install bitcore-message-bzedge
```
